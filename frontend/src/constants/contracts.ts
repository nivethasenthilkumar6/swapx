...
export const LIQUIDITY_MANAGER_ABI = [
  ...
  'function checkPair(address tokenA, address tokenB) view returns (address pair, bool exists)',
  'function getReserves(address tokenA, address tokenB) view returns (uint256 reserveA, uint256 reserveB)',
  'function getLPBalance(address tokenA, address tokenB, address user) view returns (uint256 balance, uint256 totalSupply, address pair)',
];
